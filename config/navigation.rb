...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :home, 'Главная', products_path
    primary.item :log_in, 'Войти', new_user_session_path, unless: -> { current_user }
    primary.item :log_out, 'Выйти', destroy_user_session_path, method: :delete, if: -> { current_user }
